...
async function loadLazy(doc) {
  ...
  if (pathname.includes('personal-loan-welcome')) {
    ...
    initOtpPage();
  } else if (pathname.includes('personal-loan-offer')) {
    const { initOfferPage } = await import('./loan-journey.js');
    initOfferPage();
  ...
  } else if (pathname.includes('personal-loan-get-bureau-offer')) {
    const { initBureauOfferPage } = await import('./loan-journey.js');
    initBureauOfferPage();
