...
export async function initOtpPage() {
  ...
  // Pre-fill OTP field with the value generated by the API on the previous page
  const mobileOtp = sessionStorage.getItem('mobileOtp');
  if (mobileOtp) setField(form, 'otp_code', mobileOtp);
